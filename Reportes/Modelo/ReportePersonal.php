...
class ReportePersonal
{
    ...
    public function ReciboDePagoMatricula($id)
    {
        $sql = "SELECT 
                    ...
                    UPPER(i.correo) AS institucion_correo,
                    i.direccion AS institucion_direccion,
                    t.nombre_apellido AS institucion_trabajador,
                    t.dni AS institucion_trabajador_dni,
                    t.telefono AS institucion_trabajador_telefono,
                    t.direccion AS institucion_trabajador_direccion,
                    l.nombre AS lectivo, 
                    n.nombre AS nivel, 
                    g.nombre AS grado, 
                    ...
                    TIMESTAMPDIFF(YEAR, a.nacimiento, CURDATE()) AS alumno_edad,
