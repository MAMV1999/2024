...
class Institucion
{
    ...
    {
        $sql = "INSERT INTO institucion (nombre, id_trabajador, telefono, correo, direccion) VALUES ('$nombre', '$id_trabajador', '$telefono', '$correo', '$direccion')";
    ...
    {
        $sql = "UPDATE institucion SET nombre='$nombre', id_trabajador='$id_trabajador', telefono='$telefono', correo='$correo', direccion='$direccion' WHERE id='$id'";
        return ejecutarConsulta($sql);
    }
    ...
    {
        $sql = "SELECT i.id, i.nombre, t.nombre_apellido AS trabajador, i.telefono, i.correo, i.direccion, i.estado FROM institucion i LEFT JOIN trabajador t ON i.id_trabajador = t.id";
        return ejecutarConsulta($sql);
    }
    ...
    {
        $sql = "SELECT t.id, t.nombre_apellido FROM trabajador t LEFT JOIN institucion i ON t.id = i.id_trabajador AND i.estado = '1' WHERE t.cargo='DIRECTOR' AND t.estado='1' AND i.id_trabajador IS NULL";
        return ejecutarConsulta($sql);
    }
}
?>
