...
<main class="container">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
        ...
        <small class="d-block text-end mt-3">
            <button type="button" onclick="MostrarFormulario();cargar_directores();" class="btn btn-success">Agregar</button>
        </small>
    </div>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm" id="formulario">
        ...
        <form id="frm_form" name="frm_form" method="post">
            ...
            <div class="p-3">
                <label for="id_trabajador" class="form-label"><b>DIRECTOR:</b></label>
                <div class="input-group">
                    <select id="id_trabajador" name="id_trabajador" class="form-control selectpicker" data-live-search="true"></select>
                </div>
            </div>
