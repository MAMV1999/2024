...
?>
    ...
    <main class="container">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm" id="listado">
            <h5 class="border-bottom pb-2 mb-0"><b>COMPETENCIAS - LISTADO</b></h5>
            <div class="p-3">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm" id="formulario">
            <h5 class="border-bottom pb-2 mb-0"><b>COMPETENCIAS - FORMULARIO</b></h5>
                    ...
                    <table class="table table-bordered" id="detalles">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 40%;">ÁREA CURRICULAR</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><select name="area_curricular_id[]" class="form-control selectpicker" data-live-search="true" required></select></td>
